// v2 candidate spike server (plan §4): the probe tool on @modelcontextprotocol/server.
//
...
//
// Wiring is deliberately identical to the v1 server: same probe definition, same handler,
...
const server = new McpServer({ name: "spendbar-probe-v2", version: "0.0.0-spike" });
...
log("spendbar-probe-server ready v2");
